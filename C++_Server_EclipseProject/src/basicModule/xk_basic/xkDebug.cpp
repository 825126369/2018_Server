...
int xk_Debug::Log(const string str)
{
	cout<<str<<endl;
	 return 0;
}
...
int xk_Debug::Log(const int str)
{
	cout<<str<<endl;
	 return 0;
}

int xk_Debug::Log(const char* str,const void* value)
{
	cout<<str<<value<<endl;
	 return 0;
}
...
int xk_Debug::LogBitStr(const unsigned char* str)
{
	//cout << bitset<sizeof(int)*8*(strlen(str))>(n) << endl;
}
