...
const ProtoCommand ProtoCommand_MIN = PROTO_CHAT;
...
template <> struct is_proto_enum< ::ProtoCommand> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::ProtoCommand>() {
  return ::ProtoCommand_descriptor();
}
